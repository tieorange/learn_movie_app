...
MovieResponseModel welcomeFromJson(String str) => MovieResponseModel.fromJson(json.decode(str));
...
class MovieResponseModel {
  ...
  factory MovieResponseModel.fromJson(Map<String, dynamic> json) => new MovieResponseModel(
    page: json["page"],
    totalResults: json["total_results"],
    totalPages: json["total_pages"],
    results: new List<Movie>.from(json["results"].map((x) => Movie.fromJson(x))),
  );
